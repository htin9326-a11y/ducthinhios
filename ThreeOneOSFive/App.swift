...
struct ThreeOneOSFiveApp: App {
    ...
    init() {
        setupLogCapture()
        log("app: PRIME AIMLOCK V1 launching — iOS \(AppInfo.osVersion) (\(AppInfo.osBuild)) \(AppInfo.machineName)")
    }
...
// MARK: - PRIME AIMLOCK V1 License / Admin Server
...
final class LicenseSession: ObservableObject {
    ...
    var supportURL: URL {
        ...
        return URL(string: "https://zalo.me/84827865031")!
    }
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 22) {
                        ...
                        VStack(spacing: 7) {
                            Text("KÍCH HOẠT PRIME AIMLOCK V1")
                                .font(.system(size: 24, weight: .black, design: .rounded))
                                .foregroundStyle(.white)
                            Text("Key được cấp bởi Admin Đức Thịnh VN")
                                .font(.subheadline)
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            Label("PRIME AIMLOCK V1 • Secure License", systemImage: "lock.shield.fill")
                        }
                        .font(.caption)
